			...
			<div class="pd-ltr-20 xs-pd-20-10">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <option  class="btn btn-link btn-sm" target="_blank"  value="mpdf.php?edit=<?php echo $row['id']; ?>">View</option>
                            
						<option  class="btn btn-link btn-sm"  value="payslip_download.php?edit=<?php echo $row['id']; ?>">Download</option>
